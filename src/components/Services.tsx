          ...
          <div className="services-grid grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <button
                ...
                className="service-card reveal relative overflow-hidden px-6 py-10 sm:px-8 sm:py-12 md:py-14 rounded-2xl border transition-all duration-300 ease-out cursor-pointer shadow-sm hover:shadow-xl hover:scale-[1.02] text-left"
                style={styles.card}
              >
      ...
      {selectedService !== null && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setSelectedService(null)}
              className={`absolute top-4 right-4 z-20 w-10 h-10 flex items-center justify-center rounded-full transition-colors ${
                isDark
            ...
            <div className="relative z-10 p-6 sm:p-8 md:p-10">
              <h3 className={`text-3xl sm:text-4xl font-[Instrument_Serif] mb-6 ${
