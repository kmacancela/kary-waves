          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-0">
              <a
                ...
                className="w-11 h-11 flex items-center justify-center hover:opacity-70 transition-all"
              >
              ...
              <span className={`text-base ${isDark ? 'text-[--color-cream]/60' : 'text-[--color-espresso]/50'}`}>@karywaves</span>
            </div>
          </div>
